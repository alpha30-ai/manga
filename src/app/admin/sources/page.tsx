...
export default function AdminSourcesPage() {
  ...
  return (
    <div className="space-y-8 w-full min-w-0" dir="rtl">
      ...
      <div className="bg-gradient-to-l from-slate-900 via-indigo-950 to-zinc-900 border border-slate-700/60 dark:border-zinc-800 rounded-3xl p-6 sm:p-8 shadow-xl flex flex-col md:flex-row md:items-center justify-between gap-6 relative overflow-hidden">
        <div className="space-y-2 relative z-10">
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-white/10 text-white rounded-full text-xs font-black border border-white/20">
            <Layers className="w-3.5 h-3.5 text-[#FF334B]" />
        ...
        <div className="flex flex-wrap gap-2.5 relative z-10">
          <button
            ...
            className="px-5 py-3 bg-gradient-to-l from-[#FF334B] to-rose-600 hover:opacity-90 disabled:opacity-50 text-white font-bold text-xs sm:text-sm rounded-2xl shadow-lg shadow-rose-500/25 transition-all flex items-center gap-2"
          >
          ...
          >
            <Plus className="w-4 h-4 text-[#FF334B]" />
      ...
      {/* Sources Table */}
      <div className="bg-white dark:bg-zinc-900 rounded-3xl border border-slate-200/90 dark:border-zinc-800 overflow-hidden shadow-sm p-6 space-y-4">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-right text-xs sm:text-sm">
            ...
            <tbody className="divide-y divide-slate-100 dark:divide-zinc-800/60">
              ...
              {sources.map((source) => (
                <tr key={source.id} className="hover:bg-slate-50 dark:hover:bg-zinc-800/40 transition-colors">
                  <td className="p-4 sm:p-5 font-black text-slate-950 dark:text-white">
                    <div className="flex items-center gap-3">
                      <div className="w-9 h-9 rounded-xl bg-rose-50 dark:bg-rose-950/50 flex items-center justify-center text-[#FF334B] shadow-inner">
                  ...
                  <td className="p-4 sm:p-5 font-mono text-slate-500 text-xs" dir="ltr">
                    <a
                      href={source.baseUrl}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="hover:text-[#FF334B] dark:hover:text-[#FF334B] inline-flex items-center gap-1 transition-colors"
                    >
                  ...
                  <td className="p-4 sm:p-5">
                    <span className="px-2.5 py-1 rounded-lg text-xs font-bold bg-slate-100 dark:bg-zinc-800 text-slate-700 dark:text-zinc-300">
                      {source.language}
                    </span>
                  </td>
                  ...
                  <td className="p-4 sm:p-5 text-left">
                    <div className="flex items-center justify-end gap-2">
                      <Link
                        ...
                        target="_blank"
                        className="px-3 py-1.5 bg-slate-100 dark:bg-zinc-800 hover:bg-slate-200 dark:hover:bg-zinc-750 text-slate-700 dark:text-zinc-300 rounded-xl text-xs font-bold transition-colors"
                      >
                        معاينة الأعمال
                      </Link>
        ...
        <div className="fixed inset-0 z-50 bg-black/70 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-white dark:bg-zinc-900 border border-slate-200 dark:border-zinc-800 rounded-3xl w-full max-w-md p-6 sm:p-8 space-y-6 shadow-2xl animate-in fade-in zoom-in-95">
            <div className="flex items-center justify-between">
              <h3 className="font-black text-lg text-slate-950 dark:text-white">إضافة مصدر أو سيرفر جديد</h3>
            ...
            <form onSubmit={handleAddSource} className="space-y-4">
              <div>
                <label className="block text-xs font-bold text-slate-700 dark:text-zinc-300 mb-1">اسم المصدر</label>
                <input
                  type="text"
                  required
                  ...
                  className="w-full px-4 py-3 bg-slate-50 dark:bg-zinc-800 border border-slate-300 dark:border-zinc-700 rounded-xl text-sm outline-none focus:ring-2 focus:ring-[#FF334B]"
                />
              </div>

              <div>
                <label className="block text-xs font-bold text-slate-700 dark:text-zinc-300 mb-1">الرابط الأساسي (Base URL)</label>
                <input
                  type="url"
                  required
              ...
              <div>
                <label className="block text-xs font-bold text-slate-700 dark:text-zinc-300 mb-1">اللغة</label>
                <select
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="flex-1 py-3 bg-gradient-to-l from-[#FF334B] to-rose-600 hover:opacity-90 text-white rounded-xl font-bold text-xs shadow-md shadow-rose-500/25 flex items-center justify-center gap-1.5"
                >
