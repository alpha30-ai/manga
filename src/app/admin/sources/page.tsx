      ...
      <div className="bg-gradient-to-l from-slate-900 via-indigo-950 to-zinc-900 border border-slate-700/60 dark:border-zinc-800 rounded-3xl p-6 sm:p-8 shadow-xl flex flex-col md:flex-row md:items-center justify-between gap-6 relative overflow-hidden">
        <div className="space-y-2 relative z-10">
          ...
          <p className="text-xs sm:text-sm text-slate-300 max-w-2xl leading-relaxed">
            التحكم في مصادر سحب الفصول (أزورا، مانجا ليك، العاشق، روكس، MangaDex، وغيرها) وإمكانية استيراد أحدث الإضافات السحابية بضغطة زر.
          </p>
        </div>
        ...
        <div className="flex flex-wrap gap-2.5 relative z-10">
          ...
          >
            ...
            <span>مزامنة واستيراد المصادر السحابية (Cloud Sync)</span>
          </button>
                ...
                <tr key={source.id} className="hover:bg-slate-50 dark:hover:bg-zinc-800/40 transition-colors">
                  <td className="p-4 sm:p-5 font-black text-slate-950 dark:text-white">
                    <div className="flex items-center gap-3">
                      <div className="w-9 h-9 rounded-xl bg-slate-100 dark:bg-zinc-800 flex items-center justify-center text-[#FF334B] shadow-inner">
                  ...
                  <td className="p-4 sm:p-5 font-mono text-slate-500 text-xs" dir="ltr">
                    <a
                      ...
                      className="hover:text-[#FF334B] inline-flex items-center gap-1 transition-colors"
                    >
                  ...
                  <td className="p-4 sm:p-5 text-left">
                    <div className="flex items-center justify-end gap-2">
                      <Link
                        ...
                        target="_blank"
                        className="px-3 py-1.5 bg-slate-100 dark:bg-zinc-800 hover:bg-slate-200 text-slate-700 dark:text-zinc-300 rounded-xl text-xs font-bold transition-colors"
                      >
                        معاينة الأعمال
                      </Link>
            ...
            <form onSubmit={handleAddSource} className="space-y-4">
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="flex-1 py-3 bg-[#FF334B] hover:bg-rose-600 text-white rounded-xl font-bold text-xs shadow-md shadow-rose-500/25 flex items-center justify-center gap-1.5"
                >
