    ...
    <div className="space-y-8 w-full min-w-0" dir="rtl">
      ...
      <div className="bg-gradient-to-l from-slate-900 via-indigo-950 to-zinc-900 border border-slate-700/60 dark:border-zinc-800 rounded-3xl p-6 sm:p-8 shadow-xl flex flex-col md:flex-row md:items-center justify-between gap-6 relative overflow-hidden">
        ...
        <div className="flex flex-wrap gap-2.5 relative z-10">
          ...
          <Link
            href="/admin/requests"
            className="px-5 py-3 bg-gradient-to-l from-[#FF334B] to-rose-600 hover:opacity-90 text-white font-bold text-xs sm:text-sm rounded-2xl shadow-lg shadow-rose-500/25 transition-all flex items-center gap-2"
          >
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-3xl border border-slate-200/90 dark:border-zinc-800 overflow-hidden shadow-sm flex flex-col">
          <div className="p-5 border-b border-slate-100 dark:border-zinc-800 flex items-center justify-between bg-slate-50/80 dark:bg-zinc-800/60">
            <h3 className="font-bold text-base text-slate-900 dark:text-white flex items-center gap-2">
              <Users className="w-5 h-5 text-[#FF334B]" />
                  ...
                  <span
                    className={`px-2.5 py-1 rounded-full text-[11px] font-black ${
                      u.role === "ADMIN"
                        ...
                        : "bg-rose-50 dark:bg-rose-950/60 text-[#FF334B]"
                    }`}
                  >
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-3xl border border-slate-200/90 dark:border-zinc-800 overflow-hidden shadow-sm flex flex-col">
          ...
          <div className="divide-y divide-slate-100 dark:divide-zinc-800 flex-1">
            {recentComments.map((c) => (
              <div key={c.id} className="p-4 flex items-start gap-3 hover:bg-slate-50 dark:hover:bg-zinc-800/40 transition-colors">
                <div className="w-10 h-10 rounded-2xl bg-rose-50 dark:bg-rose-950/50 text-[#FF334B] flex items-center justify-center font-bold text-sm shrink-0">
                  {c.user?.name?.[0] || "U"}
                </div>
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-slate-600 dark:text-zinc-300 line-clamp-2 leading-relaxed bg-slate-50 dark:bg-zinc-800/60 p-2.5 rounded-xl border border-slate-100 dark:border-zinc-700/50">
                    {c.content}
                  </p>
                </div>
              </div>
