...
export default async function SingleSourcePage({
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 md:py-12 pb-24 md:pb-16" dir="rtl">
      ...
      {/* Source Header Banner - Crisp Light & Dark Mode */}
      <div className="bg-white dark:bg-zinc-900 border border-slate-200/90 dark:border-zinc-800 rounded-3xl p-6 sm:p-8 mb-10 shadow-sm">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
          <div className="flex items-center gap-4">
            <div className="w-16 h-16 rounded-2xl bg-rose-50 dark:bg-rose-950/40 border border-rose-200 dark:border-rose-900/50 flex items-center justify-center text-[#FF334B] shadow-inner shrink-0">
            ...
            <div>
              ...
              <a
                ...
                className="text-xs text-slate-500 dark:text-zinc-400 hover:text-[#FF334B] transition-colors mt-1 inline-flex items-center gap-1 font-mono"
                dir="ltr"
              >
                <span>{sourceUrl}</span>
          ...
          <form method="GET" action={`/sources/${id}`} className="w-full sm:w-80 relative">
            <input
              ...
              className="w-full pl-4 pr-11 py-3 bg-slate-50 dark:bg-zinc-800 border border-slate-300 dark:border-zinc-700 rounded-2xl text-xs sm:text-sm text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-[#FF334B] shadow-sm"
            />
          ...
          >
            <div className="relative aspect-[2/3] overflow-hidden bg-slate-100 dark:bg-zinc-800">
              ...
              <div className="absolute bottom-2.5 right-2.5">
                <span className="inline-block px-2.5 py-0.5 text-[10px] font-bold bg-[#FF334B] text-white rounded-md shadow-sm">
            ...
            <div className="p-3.5 flex-1 flex flex-col justify-between">
              <h3 className="font-black text-slate-950 dark:text-white text-xs sm:text-sm leading-tight line-clamp-2 group-hover:text-[#FF334B] transition-colors">
                {m.title}
              </h3>
