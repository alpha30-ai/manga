  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 md:py-12 pb-24 md:pb-16" dir="rtl">
      ...
      <div className="mb-10 text-center sm:text-right space-y-2">
        <div className="inline-flex items-center gap-2 text-indigo-600 dark:text-indigo-400 text-xs font-bold">
        ...
        <p className="text-zinc-600 dark:text-zinc-400 text-xs sm:text-sm max-w-2xl">
